...
#define TIDESDK_PROCESS_API EXPORT
#elif defined(OS_WIN32)
#ifdef TIDESDK_PROCESS_API_EXPORT
#define TIDESDK_PROCESS_API __declspec(dllexport)
#else
# define TIDESDK_PROCESS_API __declspec(dllimport)
# endif
