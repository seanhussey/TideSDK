...
namespace TideUtils
{
    TIDE_UTILS_API std::string CFStringToUTF8(CFStringRef cfstring);
    TIDE_UTILS_API CFStringRef UTF8ToCFString(const std::string& input);
    TIDE_UTILS_API std::string CFErrorToString(CFErrorRef cferror);
