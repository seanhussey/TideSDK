...
TIDE_API NSString *TideStackTrace(void);
TIDE_API void TideDumpStackTrace(); 

TIDE_API NSString *TideStackTraceFromException(NSException *e);
TIDE_API void TideDumpStackTraceFromException(NSException* e);
