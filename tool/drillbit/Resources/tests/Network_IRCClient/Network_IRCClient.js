...
describe("Network.IRCClient", {
  ...
  test_network_IRCClient_object: function () {
    value_of(this.client.connect)
      .should_be_function();
    value_of(this.client.connected)
      .should_be_boolean();
    value_of(this.client.disconnect)
      .should_be_function();
    value_of(this.client.getNick)
      .should_be_function();
    value_of(this.client.getUsers)
      .should_be_function();
    value_of(this.client.isOp)
      .should_be_function();
    value_of(this.client.isVoice)
      .should_be_function();
    value_of(this.client.join)
      .should_be_function();
    value_of(this.client.send)
      .should_be_function();
    value_of(this.client.setNick)
      .should_be_function();
    value_of(this.client.unjoin)
      .should_be_function();
