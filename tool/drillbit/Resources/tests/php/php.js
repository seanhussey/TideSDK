...
describe("PHP tests", {
  test_bind_types: function () {
    ...
    value_of(obj.object)
      .should_be_object();
    value_of(obj.object.testmethod)
      .should_be_function();

    obj.object.testmethod();
    value_of(obj.object.value)
      .should_be(100);
  },
  ...
  test_js_types: function () {
    ...
    value_of(test_js_type_null(null))
      .should_be_true();
    value_of(test_js_type_null(undefined))
      .should_be_true();
  ...
  test_calling_method_props_obj: function () {
    ...
    var funarg = function (arg) {
      return arg;
    };
    obj.f = fun2;
    obj.f2 = funarg;
    value_of(test_call_method_prop(obj))
      .should_be(1);
    value_of(test_call_method_prop_with_arg(obj, "toots"))
      .should_be("toots");
  },
  test_calling_method_props_array: function () {
    ...
    arr.f = fun2;
    arr.f2 = funarg;
    value_of(test_call_method_prop(arr))
      .should_be(1);
    value_of(test_call_method_prop_with_arg(arr, "toots"))
      .should_be("toots");
  },
  test_calling_method_props_method: function () {
    ...
    fun.f = fun2;
    fun.f2 = funarg;
    value_of(test_call_method_prop(fun))
      .should_be(1);
    value_of(test_call_method_prop_with_arg(fun, "toots"))
      .should_be("toots");
  },
  test_class_visibility: function () {
    var hammer = looks_like_a_nail();
    value_of(hammer.publicVariable)
      .should_be("bar");
    value_of(hammer.privateVariable)
      .should_be_undefined();
    value_of(hammer.publicMethod)
      .should_be_function();
    value_of(hammer.publicMethod())
      .should_be("foo");
    value_of(hammer.privateMethod)
      .should_be_undefined();
  },
    ...
    w.addEventListener(Ti.PAGE_LOADED, function (event) {
      ...
      try {
        function domValue(id) {
          return w.getDOMWindow()
            .document.getElementById(id)
            .innerHTML;
        }
        value_of(domValue("a"))
          .should_be("101");
        value_of(domValue("request-uri"))
          .should_be("/test.php?param1=1&amp;param2=2");
        value_of(domValue("script-name"))
          .should_be("/test.php");
        value_of(domValue("param1"))
          .should_be(1);
        value_of(domValue("param2"))
          .should_be(2);
  ...
  test_deep_global_variable_isolation_as_async: function (callback) {
    Ti.page_two_loaded = function () {
      ...
      if (result == "page two") {
        ...
        callback.failed('$substance should have been "page two" was: ' + result);
      }
    };
  ...
  test_include_access: function () {
    value_of(test_include())
      .should_be("yes");
  },
  test_cased_function_names: function () {
    value_of(CamelCaseFunctionOne())
      .should_be("uno");
    value_of(camelCaseFunctionTwo())
      .should_be("dos");
    value_of(ALLCAPSFUNCTION())
      .should_be("tres");
  },
  test_mysql: function () {
    value_of(php_test_mysql())
      .should_be_true();
  },
  test_curl: function () {
    value_of(php_test_curl())
      .should_be_true();
  },
