...
describe("Ti.Filesystem File tests", {
  ...
  file_props: function () {
    ...
    value_of(f.isHidden())
      .should_be_false();
    value_of(f.isSymbolicLink())
      .should_be_false();
    value_of(f.isExecutable())
      .should_be_false();
    value_of(f.isReadonly())
      .should_be_false();
    value_of(f.isWriteable())
      .should_be_true();
    value_of(f.createTimestamp())
      .should_not_be_null();
    value_of(f.modificationTimestamp())
      .should_not_be_null();
  ...
  directory_listing: function () {
    ...
    value_of(subDirListings)
      .should_not_be_null();
    value_of(subDirListings.length)
      .should_be(1);
  },
  ...
  parent: function () {
    ...
    var parent = f.parent();
    value_of(parent.toString())
      .should_be(this.base.toString());
  },
  ...
  file_permissions: function () {
    ...
    value_of(f.setReadonly())
      .should_be_true();
    value_of(f.isReadonly())
      .should_be_true();
    value_of(f.isWritable())
      .should_be_false();

    value_of(f.setWriteable())
      .should_be_true();
    value_of(f.isWriteable())
      .should_be_true();
    value_of(f.isReadonly())
  ...
  test_read_large_file: function () {
    ...
    file.deleteFile();
    value_of(contents.length)
      .should_be(data[1].length);
    value_of(String(contents))
      .should_be(data[1]);
  },
