...
describe("Database Tests", {
  ...
  basic_query_tests: function () {
    ...
    value_of(rs.isValidRow())
      .should_be_false();
    value_of(rs.fieldCount())
      .should_be_zero();
    value_of(rs.fieldName(0))
      .should_be_null();
    value_of(rs.field(0))
      .should_be_null();
    ...
    value_of(rs.fieldName(0))
      .should_be('name');
    value_of(rs.fieldByName('name'))
      .should_be('a');
    value_of(rs.fieldCount())
      .should_be(1);
    value_of(this.db.lastInsertRowId)
      .should_be(1);
    rs.close();
