...
describe("UI.Menu", {
  test_basic_methods: function () {
    ...
    value_of(tui.createMenuItem)
      .should_be_function();
    value_of(tui.createCheckMenuItem)
      .should_be_function();
    value_of(tui.createSeparatorMenuItem)
      .should_be_function();
    value_of(tui.setMenu)
      .should_be_function();
  ...
  test_basic_menu_methods: function () {
    ...
    value_of(menu.getItemAt)
      .should_be_function();
    value_of(menu.insertItemAt)
      .should_be_function();
    value_of(menu.removeItemAt)
      .should_be_function();
    value_of(menu.clear)
      .should_be_function();
    value_of(menu.addItem)
      .should_be_function();
    value_of(menu.addSeparatorItem)
      .should_be_function();
    value_of(menu.addCheckItem)
      .should_be_function();
  },
  test_basic_menu_item: function () {
    ...
    value_of(menuItem.setLabel)
      .should_be_function();
    value_of(menuItem.getIcon)
      .should_be_function();
    value_of(menuItem.setIcon)
      .should_be_function();
    value_of(menuItem.addItem)
      .should_be_function();
    value_of(menuItem.addSeparatorItem)
      .should_be_function();
    value_of(menuItem.addCheckItem)
      .should_be_function();
    value_of(menuItem.getLabel())
      .should_be("Blahblah");
  },
  test_basic_menu_append_and_getitemat: function () {
    ...
    value_of(menu.getLength())
      .should_be(3);
    value_of(menu.getItemAt(0)
      .equals(item1))
      .should_be_true();
    value_of(menu.getItemAt(1)
      .equals(item2))
      .should_be_true();
    value_of(menu.getItemAt(2)
      .equals(item3))
      .should_be_true();
  ...
  test_invalid_insertitemat: function () {
    ...
    var exc = true;
    try {
      menu.insertItemAt(-1, item2);
      exc = false;
    } catch (e) {}
    value_of(exc)
      .should_be(true);
    try {
      menu.insertItemAt(-100, item2);
      exc = false;
    } catch (e) {}
    value_of(exc)
      .should_be(true);
  ...
  test_basic_menu_add_separator: function () {
    ...
    value_of(item1.isSeparator())
      .should_be(true);
    value_of(item1.isCheck())
      .should_be(false);
  },
  test_basic_menu_add_item: function () {
    ...
    value_of(item1.isCheck())
      .should_be(false);
    value_of(item1.getLabel())
      .should_be("MyMyLabel");
    value_of(item1.getIcon())
